@include('emails.api.header-mail')
	...
	<div style="font-size: 14px; font-weight: 500; margin-bottom: 20px; font-family:Arial,Helvetica,sans-serif;">
		<p style="text-align:start;margin-bottom:9px; color:#181C32; font-size: 18px; font-weight:600">Hi {{ucfirst($user->first_name)}} {{ucfirst($user->last_name)}},</p>
		<p style="text-align:start;margin-bottom:2px; color:#7E8299">Thank you for placing your order with {{getenv('APP_NAME')}}. Your order will be dispatched between 1-2 working days.</p>
