@include('emails.header-mail')
	...
	<a href="https://crm.excelwater.ca/reset-password/{{$token}}" style="background-color:#17114c; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;text-decoration:none;">Reset Password</a>
	<div style="font-size: 14px; font-weight: 500; margin-bottom: 20px; font-family:Arial,Helvetica,sans-serif;">
